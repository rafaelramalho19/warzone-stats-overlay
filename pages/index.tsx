  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.description}>
          <Button className={styles.buttonWrapper} theme="twitch" onClick={() => signIn('twitch', { callbackUrl: '/twitch' })}>
            Login with <TwitchLogo width="20" height="20" fill="#FFF" alt="twitch" />
          </Button>
          <Button className={styles.buttonWrapper} onClick={() => signIn('google', { callbackUrl: '/google' })}>
            Login with <GoogleLogo width="20" height="20" alt="google" />
          </Button>
        </p>

        <footer className={styles.footer}>
          <i className={styles.footerInfo}>
          Powered by <a href="https://twitch.tv/raisingz">Raisingz</a>
          </i>
